...
public class Design {
    ...
    public static class Node {
        ...
        @EqualsAndHashCode(callSuper = true)
        @Data
        public static class WriteStarRocks extends Properties {
            @NotBlank(message = "写入StarRocks数据源不能为空")
            private String datasourceCode;
            @NotBlank(message = "写入StarRocks数据库不能为空")
            private String schemaCode;
            @NotBlank(message = "写入StarRocks表不能为空")
            private String tableCode;
        }

        @EqualsAndHashCode(callSuper = true)
        @Data
        public static class RabbitReceive extends Properties {
            @NotBlank(message = "RabbitMQ消费数据源不能为空")
            private String datasourceCode;
            @NotBlank(message = "RabbitMQ消费队列不能为空")
            private String queue;
            @NotBlank(message = "RabbitMQ消费状态不能为空")
            private String status;
             ...
             * 0 表示不启用超时
             */
            private int batchReceiveTimeout = 5000;
            /**
             * 批量消费的数量
             * <p>
             * 如果消息内容已经是批量记录
        ...
        @EqualsAndHashCode(callSuper = true)
        @Data
        public static class RabbitSend extends Properties {
            @NotBlank(message = "RabbitMQ发送数据源不能为空")
            private String datasourceCode;
            @NotBlank(message = "RabbitMQ发送交换机不能为空")
            private String queue;
        ...
        @EqualsAndHashCode(callSuper = true)
        @Data
        public static class RocketReceive extends Properties {
            @NotBlank(message = "RocketMQ消费数据源不能为空")
            private String datasourceCode;
            @NotBlank(message = "RocketMQ消费主题不能为空")
            private String topic;
            @NotBlank(message = "RocketMQ消费状态不能为空")
            private String status;
        ...
        @EqualsAndHashCode(callSuper = true)
        @Data
        public static class RocketSend extends Properties {
            @NotBlank(message = "RocketMQ发送数据源不能为空")
            private String datasourceCode;
            @NotBlank(message = "RocketMQ发送主题不能为空")
            private String topic;
            /**
             * 批量数据拆分发送，每批多少
             */
            private int batchSplitSize = 100;
        }
        ...
        @EqualsAndHashCode(callSuper = true)
        @Data
        public static class QueryStarRocks extends Properties {
            @NotBlank(message = "查询StarRocks数据源不能为空")
            private String datasourceCode;
            @NotBlank(message = "查询StarRocks查询脚本不能为空")
            private String selectText;
            private String queryType;
            private Long limit;
            /**
        ...
        @EqualsAndHashCode(callSuper = true)
        @Data
        public static class QueryPostgreSQL extends Properties {
            @NotBlank(message = "查询PostgreSQL数据源不能为空")
            private String datasourceCode;
            @NotBlank(message = "查询PostgreSQL查询脚本不能为空")
            private String selectText;
            private String queryType;
            private Long limit;
            /**
        ...
        @EqualsAndHashCode(callSuper = true)
        @Data
        public static class QueryClickHouse extends Properties {
            @NotBlank(message = "查询ClickHouse数据源不能为空")
            private String datasourceCode;
            @NotBlank(message = "查询ClickHouse查询脚本不能为空")
            private String selectText;
            private String queryType;
            private Long limit;
            /**
        ...
        @EqualsAndHashCode(callSuper = true)
        @Data
        public static class WritePostgreSQL extends Properties {
            private CustomSQL customSQL;
            @NotBlank(message = "写入PostgreSQL数据源不能为空")
            private String datasourceCode;
            @NotBlank(message = "写入PostgreSQL数据库不能为空")
            private String schemaCode;
            @NotBlank(message = "写入PostgreSQL表不能为空")
            private String tableCode;
            @NotNull(message = "写入PostgreSQL主键不能为空")
            private List<String> primaryKey;
        ...
        @EqualsAndHashCode(callSuper = true)
        @Data
        public static class QueryOracle extends Properties {
            @NotBlank(message = "查询Oracle数据源不能为空")
            private String datasourceCode;
            @NotBlank(message = "查询Oracle查询脚本不能为空")
            private String selectText;
            private String queryType;
            private Long limit;
            /**
        ...
        @EqualsAndHashCode(callSuper = true)
        @Data
        public static class QueryDameng extends Properties {
            @NotBlank(message = "查询Dameng数据源不能为空")
            private String datasourceCode;
            @NotBlank(message = "查询Dameng查询脚本不能为空")
            private String selectText;
            private String queryType;
            private Long limit;
            /**
        ...
        @EqualsAndHashCode(callSuper = true)
        @Data
        public static class WriteOracle extends Properties {
            /**
             * 必填
             */
            @NotNull(message = "写入Oracle主键不能为空")
            private List<String> primaryKey;
            private CustomSQL customSQL;
            @NotBlank(message = "写入Oracle数据源不能为空")
            private String datasourceCode;
            @NotBlank(message = "写入Oracle数据库不能为空")
            private String schemaCode;
            @NotBlank(message = "写入Oracle表不能为空")
            private String tableCode;
        ...
        @EqualsAndHashCode(callSuper = true)
        @Data
        public static class WriteDameng extends Properties {
            private List<String> primaryKey;
            private WriteOracle.CustomSQL customSQL;
            @NotBlank(message = "写入Dameng数据源不能为空")
            private String datasourceCode;
            @NotBlank(message = "写入Dameng数据库不能为空")
            private String schemaCode;
            @NotBlank(message = "写入Dameng表不能为空")
            private String tableCode;
